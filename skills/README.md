...
| [`search-indexes-partitions`](search-indexes-partitions/SKILL.md) | Choosing/scoping `_index=` — partition types, tiers, and the built-in system/audit indexes (`sumologic_audit*`, `sumologic_volume`, `sumologic_system_events`). |
